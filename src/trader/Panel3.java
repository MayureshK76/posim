       ...
       date = Date.getDate();
        ...
        if( txt_qua.getText().isEmpty() && rate.getText().isEmpty() ){
                 JOptionPane.showMessageDialog(null,"Field Is Empty");
                   ...
                   try{
             String sql1= "insert into Retail(date,cust_name,item,qua,rate,total)values('" +sqldate+ "','"+ value1 + "','"+value2+"','"+ txt_qua.getText() + "',"+ rate.getText() + ",'" + less.getText() + "')";
...
//            g2d.drawString("Customer Shopping Invoice", 30,y);y+=yShift; 
    ...
    private void initComponents() {
        ...
        btn_save1.setText("Search");
        btn_save1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_save1ActionPerformed(evt);
            }
        });
        btn_save1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btn_save1KeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                btn_save1KeyTyped(evt);
            }
        });
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(btn_save1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btn_saveKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btn_saveKeyPressed
        ...
        if( txt_qua.getText().isEmpty() && rate.getText().isEmpty() ){
            ...
            try{
                String sql1= "insert into Retail(date,cust_name,item,qua,rate,total)values('" +sqldate+ "','"+ value1 + "','"+value2+"','"+ txt_qua.getText() + "',"+ rate.getText() + ",'" + rate.getText() + "','" + less.getText() + "')";
                pst=conn.prepareStatement(sql1);
                pst.execute();
                JOptionPane.showMessageDialog(this,"Successfully saved","Record",JOptionPane.INFORMATION_MESSAGE);
                // if(no_chi.getText()== "" && kg_chi.getText()== "" && kg_chi.getText()== "" && far_rate.getText()== "" && tot_cst.getText()== "" ){
    ...
    private void btn_save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_save1ActionPerformed
        // TODO add your handling code here:
         try{
            ...
            String sql = "select * from rate where name = ?";
            pst=conn.prepareStatement(sql);
    ...
    private void btn_save1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btn_save1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_save1KeyPressed

    private void btn_save1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btn_save1KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_save1KeyTyped
